...
export default class SaigonHotel24Room27 extends React.Component{
    ...
    loadCategory = () => {
        ...
        .then((hotels) => {
            this.setState({response: hotels[0].rooms[0], roomImages: hotels[0].rooms[0].roomImages, lastImage: hotels[0].rooms[0].roomImages[4].image})
        ...
        return (
            <div onLoad={autoSlide}>
                ...
                <header className="DanangNovotel-header">
                    <Link to="/saigon/saigonhotel24" style={{color: 'white'}} className='loginform-back'>&larr;</Link>
            ...
            <div className="modal js-modal" onClick={closeModal}>
                <div className="modal-container" onClick={(event) => {
                    ...
                    <div className="modal-body">
                        ...
                        <label htmlFor="number-people" className="modal-label">
                            Số người
                        </label>
                        <input id="number-people" type="number" className="modal-input" placeholder="Số người" required />
