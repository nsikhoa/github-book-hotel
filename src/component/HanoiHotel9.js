...
class HanoiHotel9 extends React.Component {
    ...
    loadCategory = () => {
        ...
        .then((location) => {
            this.setState({response: location.data.hotels[2].rooms, name: location.data.hotels[2].hotel_name})
