...
export default class HanoiHotel9Room37 extends React.Component{
    ...
    loadCategory = () => {
        ...
        .then((location) => {
            this.setState({response: location.data.hotels[2].rooms[1], roomImages: location.data.hotels[2].rooms[1].roomImages, lastImage: location.data.hotels[2].rooms[1].roomImages[4].image})
