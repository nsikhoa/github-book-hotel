...
export default class HanoiHotel7Room10User extends React.Component{
    ...
    loadCategory = () => {
        ...
        .then((location) => {
            this.setState({response: location.data.hotels[0].rooms[1], roomImages: location.data.hotels[0].rooms[1].roomImages, lastImage: location.data.hotels[0].rooms[1].roomImages[4].image})
