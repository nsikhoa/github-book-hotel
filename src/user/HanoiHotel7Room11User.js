...
export default class HanoiHotel7Room11User extends React.Component{
    ...
    loadCategory = () => {
        ...
        .then((location) => {
            this.setState({response: location.data.hotels[0].rooms[0], roomImages: location.data.hotels[0].rooms[0].roomImages, lastImage: location.data.hotels[0].rooms[0].roomImages[4].image})
        ...
        return (
            <div onLoad={autoSlide}>
                ...
                <header className="DanangNovotel-header">
                    <Link to="/user/hanoi/userhotel7" style={{color: 'white'}} className='loginform-back'>&larr;</Link>
