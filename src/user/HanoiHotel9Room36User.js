...
export default class HanoiHotel9Room36User extends React.Component{
    ...
    loadCategory = () => {
        ...
        .then((location) => {
            this.setState({response: location.data.hotels[2].rooms[0], roomImages: location.data.hotels[2].rooms[0].roomImages, lastImage: location.data.hotels[1].rooms[0].roomImages[4].image})
        ...
        return (
            <div onLoad={autoSlide}>
                ...
                <header className="DanangNovotel-header">
                    <Link to="/user/hanoi/userhotel9" style={{color: 'white'}} className='loginform-back'>&larr;</Link>
