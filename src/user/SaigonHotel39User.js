...
class SaigonHotel39 extends React.Component {
    ...
    loadCategory = () => {
        ...
        .then((hotels) => {
            this.setState({response: hotels[1].rooms,  name: hotels[1].hotel_name})
        ...
        return (
            <div>
                ...
                <header className="DanangNovotel-header">
                    <Link to="/user/saigon" style={{color: 'white'}} className='loginform-back'>&larr;</Link>
