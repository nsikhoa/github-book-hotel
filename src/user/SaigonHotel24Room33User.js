...
export default class SaigonHotel24Room33 extends React.Component{
    ...
    loadCategory = () => {
        ...
        .then((hotels) => {
            this.setState({response: hotels[0].rooms[1], roomImages: hotels[0].rooms[1].roomImages, lastImage: hotels[0].rooms[1].roomImages[4].image})
        ...
        return (
            <div onLoad={autoSlide}>
                ...
                <header className="DanangNovotel-header">
                    <Link to="/user/saigon/saigonhotel24" style={{color: 'white'}} className='loginform-back'>&larr;</Link>
