...
export default class HanoiHotel9Room37User extends React.Component{
    ...
    loadCategory = () => {
        ...
        .then((location) => {
            this.setState({response: location.data.hotels[2].rooms[1], roomImages: location.data.hotels[2].rooms[1].roomImages, lastImage: location.data.hotels[1].rooms[0].roomImages[4].image})
