...
class HanoiHotel7User extends React.Component {
    ...
    loadCategory = () => {
        ...
        fetch('https://bookhotel-backend.herokuapp.com/api/nologin/locations/1/hotels', requestOptions)
        .then(function(response) {
            return response.json()
        })
        .then((location) => {
            this.setState({response: location.data.hotels[0].rooms,  name: location.data.hotels[0].hotel_name})
...
export default HanoiHotel7User